...
Regardless of the bioinformatic subfield or practical definition, biomolecular sequence data has always been at the core of, both, the field's origins and its current state of practice. By far, biomolecular sequences make up the greatest share of available biodata available today. Today, approximately 1.5 million sequences are submitted to the DDBJ every day (calculated using data provided by the [DDBJ website](https://www.ddbj.nig.ac.jp/statistics/index-e.html); diff. between r131 and r130).
