...
- [**EFI GNN**](https://efi.igb.illinois.edu/efi-gnt/)
...
> Ordered mutant libaries have been constructed for a dozen model organisms. This has allowed to identify essential genes  and screens these mutants in a wide variety of growth conditions include the presence of many chemicals. More recently TnSeq derived fitness data can be generated more quickly.
{.is-info}

- [**OGEE**](databases/phenotypes-fitness/OGEE)
- [**DEG**](/databases/data-integration/DEG)
- [**FitnessBrowser**](databases/phenotypes-fitness/FitnessBrowser)
