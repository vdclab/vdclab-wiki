...
> Not many webtools allow to map omics data to pathways specifically for Baceria (see [Review](https://academic.oup.com/bib/article/23/6/bbac435/6761962)). Vut a few database generate association netwoks that compile all types of data includeing Omics data.
{.is-info}
...
YeastMine  or Other Intermine database
Impala
