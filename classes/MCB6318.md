...
- [**OmicsDI** *Compilation of all typesomics data*](https://www.omicsdi.org/)
- [**Atted-II** *Plant expression data*](/databases/microarray-rnaseq/ATTED-II)
- [CoExpressDB * Model Eukaryotes exprsion data analyses]
- [iModulon](/omics-data/omics-data/iModulon)


**Organisms Specific databases**
https://genexpdb.okstate.edu/
https://vdclab-wiki.herokuapp.com/en/omics-data/omics-data/PneumoExpress
spell
