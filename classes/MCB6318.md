...
> With the genomic revolution started in 1995, microbiology has become a data science as all aspects of the field are driven by kwowledge derived from sequences ( see extra reading [here](/MCB6318_M1_additional_reading)). With >400,000 genomes sequenced ( see current number on the [GOLD database](JGI-GOLD)), gathering informations on genomes and proteins is not easy. 
