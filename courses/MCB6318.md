...
http://etetoolkit.org/ (python based, more versatile
but difficult to use if you are not strong in python)

Evolgenius http://evolgenius.info/evolview/#login
(intermediate in investment between Itol and ETE

GraPhlAn :https://peerj.com/articles/1029/
(they have a galaxy set up)
