...
> Alpha-fold is not yet optimal to  model interactions between macromolecules.  It is interesting to compare experimental data with predictions to evaluate how tthe prediction are doing.
{.is-info}
