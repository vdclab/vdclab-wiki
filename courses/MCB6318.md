...
- [**GeCoViz** *nice graphics based on EggNog*](https://gecoviz.cgmlab.org)
...
- [**Predicting different types of protein information** ](https://predictprotein.org/)
...
- [**CdiffPortal** *Clostridium diificile data*](https://networks.systemsbiology.net/cdiff-portal/)
...
**Analysis Tools** 
- [**HeatMap Maker**]( http://www2.heatmapper.ca/expression/)
- [**ClusterGrammer**](https://maayanlab.cloud/clustergrammer/)
- [**PCAtoGO**](https://pcago.bioinf.uni-jena.de/)

------------------------------------------------------------------------------
### Module 4 - Mining and Predicting 3D Protein Structures
> Protein structure/function studies are critical to many fields of biology. These can help predict catalytic mechanisms or substrate specificities for enzymes, predict and visualize protein/protein or protein/nucleic  acids complexes. The tools that make structure analysis accessible to biologists are evolving constantly, particularly with the arrival of AI-based platforms. See AI tools compilation  [HERE](https://neurosnap.ai/). 
{.is-info}
...
> Alpha-fold  was first  not optimal to  model interactions between macromolecules even if it is a very active field of study as discussed [HERE](https://www.nature.com/articles/s41467-022-28865-w). The Kurgan lab has a suite of interesting tools  in the  [BioMine servers](http://biomine.cs.vcu.edu/) including many nucleic acid binding tools. Unfortunately these tools are not very reliable yet and the servers that provide them come and go. This [paper](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9585174) reviews Protein/RNA binding prediction tools. [Alpha-fold3](https://www.nature.com/articles/s41586-024-07487-w) is supposed to be better at predicting complexes, so it worth trying.
{.is-info}
...
- [**GeneGraphics**](https://genegraphics.net/)
