...
> Protein structure/function studies are critical to many fields of biology. These can help predict catalytic mechanisms or substrate specificities for enzymes, predict and visualize protein/protein or protein/nucleic  acids complexes. The tools that make structure analysis accessible to biologists are evolving constantly, particularly with teh arrival of AI based platforms. See AI tools compilation  [HERE](https://neurosnap.ai/). 
{.is-info}
