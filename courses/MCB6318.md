...
> Alpha-fold is not yet optimal to  model interactions between macromolecules  even if the field is very active as discussed [HERE](https://www.nature.com/articles/s41467-022-28865-w).  It is interesting to compare experimental data (discussed in Module 3) with predictions to evaluate how the prediction are doing.
{.is-info}
...
- [**NCBRPred**](http://bliulab.net/NCBRPred/server)
---
